import listPaket from "@/data/listPaket.json"; // Import file JSON
...
export const getListPaketByLanguage = (language: string): Array<{
  id: number;
  destination: string;
  days: number;
  nights: number;
  ...
  return (listPaket as Package[]).map((item) => ({
    id: item.id,
